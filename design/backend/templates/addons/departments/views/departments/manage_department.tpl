...
{capture name="mainbox"}   
    ...
    <form action="{""|fn_url}" method="post" id="departments_form" name="departments_form" enctype="multipart/form-data">  
        ...
        {capture name="buttons"}
            {capture name="tools_list"}
                    <li>{btn type="list" text=__("departments.edit") href="departments.update_departments?department_id=`$department.department_id`"}</li>
                {if $departments}
        ...
        {capture name="adv_buttons"}
            ...
            {include file="common/tools.tpl" tool_href="departments.add_department" prefix="top" hide_tools="true" title=__("departments.add") icon="icon-plus"}
            {/hook}
        {/capture}
    </form>
{/capture}
    ...
    {capture name="sidebar"}
        ...
        {include file="common/saved_search.tpl" dispatch="departments.manage_department" view_type="departments"}
        {include file="addons/departments/views/departments/components/departments_search_form.tpl" dispatch="departments.manage_department"}
        {/hook}
    {/capture}
